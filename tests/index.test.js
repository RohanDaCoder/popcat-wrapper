...
describe('Popcat Wrapper', () => {
  ...
  describe('Utility Functions', () => {
    ...
    test('should throw error if username is missing in discordMessage', () => {
      ...
      }).toThrow('[Popcat Wrapper] discordMessage({ username, content, avatar, color, timestamp }) => \'username\' parameter is missing.');
    });
    ...
    test('should throw error if content is missing in discordMessage', () => {
      ...
      }).toThrow('[Popcat Wrapper] discordMessage({ username, content, avatar, color, timestamp }) => \'content\' parameter is missing.');
    });
    ...
    test('should throw error if text is missing in couldread', () => {
      expect(() => {
        wrapper.couldread();
      }).toThrow('[Popcat Wrapper] couldread(text) => \'text\' parameter is missing.');
    });
    ...
    test('should throw error if text is missing in supreme', () => {
      expect(() => {
        wrapper.supreme();
      }).toThrow('[Popcat Wrapper] supreme(text) => \'text\' parameter is missing.');
    });

    test('should generate quote URL correctly', () => {
      const url = wrapper.quote('https://example.com/image.jpg', 'Test text', 'John Doe');
    ...
    test('should throw error if any parameter is missing in quote', () => {
      ...
      }).toThrow('[Popcat Wrapper] quote(image, text, name) => Either \'image\', \'text\' or \'name\' parameter is missing.');
    ...
    test('should throw error if text length is invalid in quote', () => {
      const error = wrapper.quote('https://example.com/image.jpg', 'a'.repeat(126), 'John Doe');
    ...
    test('should throw error if any parameter is missing in happysad', async () => {
      await expect(wrapper.happysad()).rejects.toThrow('[Popcat Wrapper] happysad(text1, text2) => Either \'text1\' or \'text2\' parameter is missing.');
      await expect(wrapper.happysad('Text 1')).rejects.toThrow('[Popcat Wrapper] happysad(text1, text2) => Either \'text1\' or \'text2\' parameter is missing.');
    });
    ...
    test('should throw error if imageURL is missing in communism', async () => {
      await expect(wrapper.communism()).rejects.toThrow('[Popcat Wrapper] communism(image) => \'imageURL\' parameter is missing.');
    });
    ...
    test('should throw error if imageURL is missing in jail', () => {
      expect(() => {
        wrapper.jail();
      }).toThrow('[Popcat Wrapper] jail(imageURL) ==> \'imageURL\' parameter is missing.');
    });
    ...
    test('should throw error if text is missing in unforgivable', () => {
      ...
      }).toThrow('[Popcat Wrapper] unforgivable(text) ==> \'text\' parameter is missing.');
    });
    ...
    test('should generate ship URL correctly', () => {
      const url = wrapper.ship('https://example.com/image1.jpg', 'https://example.com/image2.jpg');
    ...
    test('should throw error if any parameter is missing in ship', () => {
      expect(() => {
        wrapper.ship();
      }).toThrow('The field image1 was left empty in the ship function. Need help? https://dsc.gg/popcatcom');
      
      expect(() => {
        wrapper.ship('https://example.com/image1.jpg');
      }).toThrow('The field image2 was left empty in the ship function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if any parameter is missing in colorify', () => {
      expect(() => {
        wrapper.colorify();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the colorify function. Need help? https://dsc.gg/popcatcom');
      
      expect(() => {
        wrapper.colorify('https://example.com/image.jpg');
      }).toThrow('[Popcat Wrapper] The field \'color\' was left empty in the colorify function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if text is missing in biden', () => {
      expect(() => {
        wrapper.biden();
      }).toThrow('[Popcat Wrapper] The field \'text\' was left empty in the biden function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if text is missing in pikachu', () => {
      expect(() => {
        wrapper.pikachu();
      }).toThrow('[Popcat Wrapper] The field \'text\' was left empty in the pikachu function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in drip', () => {
      expect(() => {
        wrapper.drip();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the drip function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in clown', () => {
      expect(() => {
        wrapper.clown();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the clown function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if text is missing in alert', () => {
      expect(() => {
        wrapper.alert();
      }).toThrow('[Popcat Wrapper] The field \'text\' was left empty in the alert function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if text is missing in caution', () => {
      expect(() => {
        wrapper.caution();
      }).toThrow('[Popcat Wrapper] The field \'text\' was left empty in the caution function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in jokeoverhead', () => {
      ...
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the jokeoverhead function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in mnm', () => {
      expect(() => {
        wrapper.mnm();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the mnm function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in uncover', () => {
      expect(() => {
        wrapper.uncover();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the uncover function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in ad', () => {
      expect(() => {
        wrapper.ad();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the ad function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in blur', () => {
      expect(() => {
        wrapper.blur();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the blur function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in invert', () => {
      expect(() => {
        wrapper.invert();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the invert function. Need help? https://dsc.gg/popcatcom');
    });
    ...
    test('should throw error if image is missing in greyscale', () => {
      expect(() => {
        wrapper.greyscale();
      }).toThrow('[Popcat Wrapper] The field \'image\' was left empty in the greyscale function. Need help? https://dsc.gg/popcatcom');
    });
  });
  ...
  describe('CodeClient Class', () => {
    ...
    test('should validate required parameters in createBin', async () => {
      ...
      await expect(client.createBin({})).rejects.toThrow("'title' parameter is required.");
      await expect(client.createBin({ title: 'Test' })).rejects.toThrow("'description' parameter is required.");
      await expect(client.createBin({ title: 'Test', description: 'Description' })).rejects.toThrow("'code' parameter is required.");
    });

    test('should validate language parameter in createBin', async () => {
      const client = new wrapper.CodeClient({ key: 'test-key' });
      
      await expect(client.createBin({
        title: 'Test',
  ...
  describe('Shortener Class', () => {
    test('should validate required parameters in shorten', async () => {
      await expect(wrapper.Shortener.shorten({})).rejects.toThrow("'url' parameter is required.");
      await expect(wrapper.Shortener.shorten({ url: 'https://example.com' })).rejects.toThrow("'extension' parameter is required.");
    });

    test('should validate required parameters in getInfo', async () => {
      await expect(wrapper.Shortener.getInfo({})).rejects.toThrow("'extension' parameter is required.");
    });
  });
  ...
  describe('Async Functions', () => {
    ...
    test('should validate required parameters in periodicTable', async () => {
      await expect(wrapper.periodicTable()).rejects.toThrow('element\' parameter is missing.');
    });

    test('should validate required parameters in imdb', async () => {
      await expect(wrapper.imdb()).rejects.toThrow('name\' parameter is missing');
    });

    test('should validate required parameters in steam', async () => {
      await expect(wrapper.steam()).rejects.toThrow('name\' parameter is missing.');
    });

    test('should validate required parameters in screenshot', async () => {
      await expect(wrapper.screenshot()).rejects.toThrow('url\' parameter is missing.');
    });

    test('should validate required parameters in lyrics', async () => {
      await expect(wrapper.lyrics()).rejects.toThrow('The field \'song\' was left empty int he LYRICS function!');
    });

    test('should validate required parameters in subreddit', async () => {
      await expect(wrapper.subreddit()).rejects.toThrow('The field \'subeddit\' was left empty in the SUBREDDIT function!');
    });
    ...
    test('should validate required parameters in sadcat', () => {
      expect(() => {
        wrapper.sadcat();
      }).toThrow('The field \'text\' was left empty in the SAD CAT function. Need help? https://popcat.xyz/server');
    });

    test('should validate required parameters in github', async () => {
      await expect(wrapper.github()).rejects.toThrow('The field \'username\' was left empty in the GITHUB function!');
    });

    test('should validate required parameters in weather', async () => {
      await expect(wrapper.weather()).rejects.toThrow('The field \'place\' was left empty in the WEATHER function!');
    });

    test('should validate required parameters in lulcat', async () => {
      await expect(wrapper.lulcat()).rejects.toThrow('The field \'text\' was left empty in the LUL CAT function. Need help? https://popcat.xyz/server');
    });
    ...
    test('should validate required parameters in country', async () => {
      await expect(wrapper.country()).rejects.toThrow('The field \'country name\' was left empty in the COUNTRY function!');
    });

    test('should validate required parameters in npm', async () => {
      await expect(wrapper.npm()).rejects.toThrow('The field \'package name\' was left empty in the NPM function!');
    });

    test('should validate required parameters in translate', async () => {
      await expect(wrapper.translate()).rejects.toThrow('The field \'text\' was left empty in the translate function. Need help? https://dsc.gg/popcatcom');
      await expect(wrapper.translate('Hello')).rejects.toThrow('The field \'to\' was left empty in the translate function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in reverse', async () => {
      await expect(wrapper.reverse()).rejects.toThrow('The field \'text\' was left empty in the reverse function');
    });

    test('should validate required parameters in colorinfo', async () => {
      await expect(wrapper.colorinfo()).rejects.toThrow('The field \'color\' was left empty in the colorinfo function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in mock', async () => {
      await expect(wrapper.mock()).rejects.toThrow('The field \'text\' was left empty in the mock function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in doublestruck', async () => {
      await expect(wrapper.doublestruck()).rejects.toThrow('The field \'text\' was left empty in the doublestruck function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in texttomorse', async () => {
      await expect(wrapper.texttomorse()).rejects.toThrow('The field \'text\' was left empty in the texttomorse function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in welcomecard', () => {
      expect(() => {
        wrapper.welcomecard();
      }).toThrow('welcomeImage(background, avatar, text_1, text_2, text_3, color) ==> background is null.');
      
      expect(() => {
        wrapper.welcomecard('https://example.com/background.png');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> avatar is null');
      
      expect(() => {
        wrapper.welcomecard('https://example.com/background.png', 'https://example.com/avatar.jpg');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> text_1 is null');
      
      expect(() => {
        wrapper.welcomecard('https://example.com/background.png', 'https://example.com/avatar.jpg', 'Text 1');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> text_2 is null');
      
      expect(() => {
        wrapper.welcomecard('https://example.com/background.png', 'https://example.com/avatar.jpg', 'Text 1', 'Text 2');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> text_3 is null');
    });

    test('should validate background URL in welcomecard', () => {
      expect(() => {
        wrapper.welcomecard('invalid-url', 'https://example.com/avatar.jpg', 'Text 1', 'Text 2', 'Text 3');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> background must be a valid URL.');
    });

    test('should validate background file type in welcomecard', () => {
      expect(() => {
        wrapper.welcomecard('https://example.com/background.jpg', 'https://example.com/avatar.jpg', 'Text 1', 'Text 2', 'Text 3');
      }).toThrow('welcomecard(background, avatar, text_1, text_2, text_3) ==> background must be a PNG.');
    });

    test('should validate required parameters in itunes', async () => {
      await expect(wrapper.itunes()).rejects.toThrow('The field \'song\' was left empty in the iTunes function.');
    });

    test('should validate required parameters in chatbot', async () => {
      await expect(wrapper.chatbot()).rejects.toThrow('The field \'content\' was left empty in the chatbot function.');
      await expect(wrapper.chatbot('Hello')).rejects.toThrow('The field \'ownername\' was left empty in the chatbot function.');
      await expect(wrapper.chatbot('Hello', 'Owner')).rejects.toThrow('The field \'botname\' was left empty in the chatbot function.');
    });

    test('should validate required parameters in encode', async () => {
      await expect(wrapper.encode()).rejects.toThrow('The field \'text\' was left empty in the encode function. Need help? https://dsc.gg/popcatcom');
    });

    test('should validate required parameters in decode', async () => {
      await expect(wrapper.decode()).rejects.toThrow('The field \'binary\' was left empty in the decode function. Need help? https://dsc.gg/popcatcom');
    });
